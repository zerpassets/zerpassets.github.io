...
var ConversionService = /** @class */ (function () {
    function ConversionService(currencyService, exchangeService, btcPriceService) {
        ...
        this.inputCalculated$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__["BehaviorSubject"](1000000);
        this.model = {
            inputValue: '1000000',
            outputValue: '1',
            inputCurrency: 'CSC',
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["forkJoin"])(this.currencyService.getAll(), this.exchangeService.getAll(), this.btcPriceService.currentPrice()).subscribe(function (responses) {
            _this.currencies$.next(responses[0]);
            _this.exchanges$.next(responses[1]);
            _this.btcPrice$.next(responses[2]);
            _this.selectedExchanges$.next(responses[1]);
            _this.selectedExchanges$.subscribe(function () {
                _this.inputUpdated({});
            });
        });
    }
    ...
    ConversionService.prototype.inputUpdated = function (model) {
        ...
        var output = this.btcPrice$.value
            .inSatoshis()
            .multipliedBy(this.priceOfCsc())
            .multipliedBy(this.model.inputValue.toString().replace(',', ''))
    ...
    ConversionService.prototype.outputUpdated = function (model) {
        Object.assign.apply(Object, [this.model].concat(model));
        var outputInDollars = new bignumber_js__WEBPACK_IMPORTED_MODULE_6___default.a(this.model.outputValue.replace(',', '')).dividedBy(this.currencyConversionFactor());
    ...
    ConversionService.CSC_TO_DROP = 100000000.0;
...
var CurrencyService = /** @class */ (function () {
    ...
    CurrencyService.prototype.getAll = function () {
        return this.httpClient
            .get(CurrencyService_1.ENDPOINT)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return data.rates; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
            return Object.keys(data).map(function (key, index) { return new _currency__WEBPACK_IMPORTED_MODULE_1__["Currency"]().deserialize({ symbol: key, value: data[key] }); });
        }));
    };
...
module.exports = ".equals {\n  padding: 0 1rem; }\n\ninput {\n  text-align: center; }\n\n.left-element {\n  border-radius: .5rem 0 0 .5rem; }\n\n.right-element {\n  border-radius: 0 .5rem .5rem 0;\n  margin-left: .5rem;\n  -webkit-appearance: none; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var src_app_data_conversion_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/data/conversion.service */ "./src/app/data/conversion.service.ts");
...
var CurrencyConverterComponent = /** @class */ (function () {
    function CurrencyConverterComponent(conversionService, currencyService, fb) {
    ...
    CurrencyConverterComponent.prototype.ngOnInit = function () {
        ...
        this.converterForm.patchValue(this.conversionService.model);
        this.converterForm.controls.inputValue.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["merge"])(this.converterForm.controls.inputCurrency.valueChanges), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["merge"])(this.converterForm.controls.outputCurrency.valueChanges), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function () { return _this.converterForm.valid; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () {
            _this.conversionService.inputUpdated(_this.converterForm.value);
        }))
            .subscribe();
        this.converterForm.controls.outputValue.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function () { return _this.converterForm.valid; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () {
        ...
        this.conversionService.outputCalculated$.subscribe(function (value) {
            return _this.converterForm.controls.outputValue.setValue(value, {
                emitEvent: false
            });
        });
        this.conversionService.inputCalculated$.subscribe(function (value) {
            return _this.converterForm.controls.inputValue.setValue(value, {
                emitEvent: false
            });
        });
    };
    CurrencyConverterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_data_conversion_service__WEBPACK_IMPORTED_MODULE_5__["ConversionService"],
...
module.exports = ".title a {\n  float: right;\n  display: inline-block; }\n\n.exchange {\n  min-width: 250px;\n  display: block;\n  cursor: pointer; }\n\n.exchange i {\n    float: right; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "app-currency-converter {\n  position: absolute;\n  top: 50%;\n  left: calc((100% - 460px) / 2); }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "app-exchange-selector {\n  margin-right: 30px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<body data-gr-c-s-loaded=\"true\" cz-shortcut-listen=\"true\">\n\n  <app-header></app-header>\n\n  <!-- Begin page content -->\n  <main role=\"main\" class=\"container\">\n    <router-outlet></router-outlet>\n  </main>\n\n  <app-footer></app-footer>\n</body>\n"
